          ...
          <div className="bg-primary-50 dark:bg-primary-900/20 rounded-2xl p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <Mail className="text-primary-600 dark:text-primary-400 mt-1" size={24} />
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    business@textcenter.com
                  </p>
                </div>
              </div>

              <div className="flex items-start">
                <Phone className="text-primary-600 dark:text-primary-400 mt-1" size={24} />
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                    Phone
                  </h3>
              ...
              <div className="flex items-start">
                <MapPin className="text-primary-600 dark:text-primary-400 mt-1" size={24} />
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                    Office
                  </h3>
          ...
          <div className="mt-12">
            ...
            <div className="space-y-4">
              {[
                ...
                {
                  question: "How do I access audiobooks?",
                  answer: "Audiobooks are available to all premium members. Simply look for the headphone icon on book covers to identify audio versions."
                }
              ].map((faq, index) => (
